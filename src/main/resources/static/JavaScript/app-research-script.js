function enableEdit(button) {
    var row = button.parentNode.parentNode.parentNode; // 获取按钮的父级行
    ...
    if (displayInput) {
        ...
        var types = [
            { id: 1, type: 'Medical Leave' },
            { id: 2, type: 'Compensation Leave' },
            { id: 3, type: 'Annual Leave' },
            { id: 4, type: 'Compensation' }
        ]; // 假设这些是应用类型
        ...
        types.forEach(function(type) {
            ...
            if (type.type === displayInput.value) { // 如果是当前应用类型
