...
public class PublicHolidayServiceImpl implements PublicHolidayService {
	...
	public void deleteHoliday(LocalDate date) {
		// TODO Auto-generated method stub
		publicHolidayRepository.deleteByDate(date);
	...
	public void updateHoliday(PublicHoliday publicHoliday) {
		// TODO Auto-generated method stub
		LocalDate d=publicHoliday.getDate();
		String t=publicHoliday.getHolidayName();
		publicHolidayRepository.updateHoliday(d,t);
	}
}
